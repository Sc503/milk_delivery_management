...
import com.example.Receivers.WifiDirectBroadcastReceiver;
import com.example.adapters.DeviceAdapter;
import com.example.databinding.ActivityWifiDirectBinding;
import com.example.models.DeviceModel;
import com.example.models.TransferState;
import com.example.services.FileTransferService;
...
public class TempWifiDirectActivity extends AppCompatActivity implements DeviceAdapter.OnDeviceClickListener {
    ...
    private void setupBroadcastFilters() {
        ...
        broadcastReceiver = new WifiDirectBroadcastReceiver(com.example.repository.WifiRepository.getInstance(this));
    }
...
//                        Toast.LENGTH_SHORT).show();
    ...
    private void refreshConnectionStatus() {
        if (viewModel != null) {
            ...
            com.example.repository.WifiRepository.getInstance(this).requestConnectionInfo();
